...
test("normalizeInstallationDependencyVersion strips personal prerelease metadata", () => {
  ...
  expect(normalizeInstallationDependencyVersion("2.0.0-beta.3")).toBe("2.0.0-beta.3")
  expect(normalizeInstallationDependencyVersion("10.20.30+build.7")).toBe("10.20.30+build.7")
