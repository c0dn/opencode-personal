...
const repo = "c0dn/opencode-personal"
const install = `https://raw.githubusercontent.com/${repo}/dev/install`
const blocked = "Personal opencode builds only support GitHub release upgrades. Reinstall with the fork installer."
      ...
      upgrade: Effect.fn("Installation.upgrade")(function* (m: Method, target: string) {
        ...
        switch (m) {
          case "curl":
            ...
            break
          default:
            return yield* new UpgradeFailedError({ stderr: blocked })
        }
