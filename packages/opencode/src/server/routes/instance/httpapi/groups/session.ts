...
import { ApiNotFoundError, ChildSessionPromptError, PermissionNotFoundError, SessionBusyError } from "../errors"
    ...
    HttpApiGroup.make("session")
      .add(
        ...
        HttpApiEndpoint.post("prompt", SessionPaths.prompt, {
          ...
          error: [HttpApiError.BadRequest, ApiNotFoundError, ChildSessionPromptError],
        }).annotateMerge(
          OpenApi.annotations({
        ...
        HttpApiEndpoint.post("shell", SessionPaths.shell, {
          ...
          success: described(SessionV1.WithParts, "Created message"),
          error: [HttpApiError.BadRequest, ApiNotFoundError, SessionBusyError, ChildSessionPromptError],
        }).annotateMerge(
          OpenApi.annotations({
