export const dict = {
  ...
  "command.agentManager.toggle": "Toggle agent manager",
  "session.agentManager.running": "{{count}} running",
  "session.agentManager.title": "Agent manager",
  "session.agentManager.empty": "No subagents yet",
  "session.agentManager.open": "Open subagent session",
  "session.agentManager.interrupt": "Interrupt subagent",
  "session.agentManager.status.running": "Running",
  "session.agentManager.status.idle": "Idle",
  "session.agentManager.status.completed": "Completed",
  "session.agentManager.status.error": "Error",
